...
namespace CRP
{
	...
	{
		_coordinates.x_1 = x_1 ;
		_coordinates.y_1 = y_1 ;
		_coordinates.x_2 = x_2 ;
		_coordinates.y_2 = y_2 ;
	}
	...
	bool TemplateParser::SetTemplate(char* temple)
	{
		...
		for (; line; line=line->NextSiblingElement())
		{
			...
			tempSt->_lineNum = atoi(&lineId[5/*MAGIC NUM*/]) ; 
			memcpy(tempSt->_description, lineDesc, sizeof(lineDesc)+1) ;
			...
			tempSt->_coordinates.x_1 = atoi (tokens[1].c_str());
			tempSt->_coordinates.y_1 = atoi (tokens[2].c_str());
			tempSt->_coordinates.x_2 = atoi (tokens[3].c_str());
			tempSt->_coordinates.y_2 = atoi (tokens[4].c_str());
